...
class BrainToTextDecoder_Trainer:
    ...
    def __init__(self, args):
        ...
        # Call torch.compile to speed up training (guard: torch.compile is
        # unreliable on some CPU-only torch builds; training still works without it)
        if torch.cuda.is_available():
    ...
    def create_optimizer(self):
        ...
        optim = torch.optim.AdamW(
            ...
            fused = torch.cuda.is_available() # fused AdamW requires CUDA
        )
